<%-- 
    Document   : Register
    Created on : Jan 28, 2020, 9:10:59 AM
    Author     : Win 10
--%>
...
<html lang="vi">
    <head>
        ...
        <!-- ================= Meta ================== -->
        <meta name="keywords" content="Đăng ký tài khoản, FreshFood, polo-theme.mysapo.net"/>		
                ...
                <section class=" margin-top-15">
                    <div class="container">
                        <div class="page_title">
                            <h1 class="title_page_h1">Tạo tài khoản</h1>
                        </div>
                        <div class="customer-form row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <f:form accept-charset="UTF-8" action="register.htm" id="customer_register" commandName="account" onsubmit="return validate()">
                                    ...
                                    <f:input type="text" class="input-control" name="address" id="address" path="address"/>
                                    ...
                                    <p class="action-btn">
                                        <input type="submit" value="Đăng ký" class="button_all">
                                        <a href="/" class="button button_all pull-right">Quay lại</a>
                                    </p>
...
//        }
        function encodeURIParams(a, b) {
            ...
            return 0 == c.length ? "" : (b ? "?" : "") + c.join("&")
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="register_forms">
                                ...
                                <form accept-charset="UTF-8" action="login.htm" id="customer_login" method="post">
                                    ...
                                    <div class="form-signup clearfix">
                                        <label>Email <span class="required">*</span></label>
                                        <input type="text" class="input-control"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"  name="email" id="emails" required="">
                                        <label>Mật khẩu <span class="required">*</span> </label>
                                        <input type="password" class="input-control" name="password" id="creat_passwords"> 
                                        <p class="required">* Yêu cầu bắt buộc</p>
            ...
            <script>
                $(function () {
                    $('#staticParent').on('keydown', '#phoneNumber', function (e) {
