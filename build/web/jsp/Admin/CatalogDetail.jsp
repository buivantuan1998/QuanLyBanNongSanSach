                                ...
                                <div class="col-xs-12">
                                    <div class="x_panel">
                                        ...
                                        <f:form class="form-horizontal form-label-left" commandName="catalog">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Mã nhà cung cấp <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:input type="text" id="supplierId"  class="form-control col-md-7 col-xs-12" path="supplierId" readonly="true"/> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Mã mùa<span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:input type="text" id="seasonId"  class="form-control col-md-7 col-xs-12" path="seasonId" /> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:input type="text" id="isDelete"  class="form-control col-md-7 col-xs-12" path="isDelete" readonly="true"/> 
                                                </div>
                                            </div>
