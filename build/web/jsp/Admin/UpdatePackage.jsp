                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h4>Quản lí ví tiền <small>  >> Sửa thông tin</small></h4>
                                            <div class="clearfix"></div>
                                        <f:form class="form-horizontal form-label-left" action="updatePackage.htm" commandName="updatePackage" onsubmit="return validate()">
                                             <div class="form-group message">
                                                 ${message}
                                             </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Mã ví tiền<span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:input type="text" id="packageId" class="form-control col-md-7 col-xs-12" path="packageId" readonly="readonly"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
