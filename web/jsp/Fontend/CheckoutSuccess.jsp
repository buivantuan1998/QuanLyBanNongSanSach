<%-- 
    ...
    Created on : Feb 11, 2020, 12:14:45 AM
    Author     : Win 10
--%>
    ...
    <head>
        ...
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
            <meta name="viewport" content="width=device-width, initial-scale=1">
                ...
                <title>FreshFood Shop - Cảm ơn quý khách</title>


                <link rel="shortcut icon" href="/QuanLyBanNongSan/jsp/Fontend/images/favicon.ico" type="image/x-icon" />

                <link href='/QuanLyBanNongSan/jsp/Fontend/css/styles.css' rel='stylesheet' type='text/css' />
                <link href="/QuanLyBanNongSan/jsp/Fontend/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
                <link href="/QuanLyBanNongSan/jsp/Fontend/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
                <link href="/QuanLyBanNongSan/jsp/Fontend/css/thankyou.css" rel="stylesheet" type="text/css" />
                ...
                <script>
                    var Bizweb = Bizweb || {};
                    Bizweb.store = 'polo-theme.mysapo.net';
                    Bizweb.theme = {"id":709526, "role":"main", "name":"FreshFood 2019-08-01"};</script>
                <script type="text/javascript">
                    //<![CDATA[
                    Bizweb.checkout = {"created_on":"2020-02-10T17:13:11Z", "currency":"VND", "customer_id":10175173, "email":"buivtuan103@gmail.com", "location_id":null, "order_id":6616864, "phone":null, "requires_shipping":true, "reservation_time":null, "source_name":"web", "source_identifier":null, "source_url":null, "taxes_included":false, "tax_exempt":false, "tax_lines":null, "token":"dc3fc793f72a41dfaa6f52f071e126ea", "updated_at":null, "payment_due":null, "payment_url":null, "reservation_time_left":0, "subtotal_price":"1700000.0000", "total_price":"1740000.0000", "total_tax":null, "line_items":[{"id":9264655, "shipping_status":null, "wait_to_ship_quantity":0, "grams":0, "price":850000.0000, "line_price":1700000.0000, "price_original":0.0, "line_price_orginal":0.0, "product_id":830917, "quantity":2, "requires_shipping":true, "sku":null, "title":"Bữa tiệc hoa hồng", "variant_id":1273199, "variant_title":"Default Title", "vendor":null, "name":"Bữa tiệc hoa hồng Default Title", "gift_card":false, "total_discount":0.0000, "shipping_service":null, "product_exist":false, "image":null, "url":null, "properties":{}, "promotionref":null, "promotionby":[]}], "shipping_rate":null, "shipping_address":{"id":0, "first_name":"Phong", "last_name":"Van", "phone":"0987654234", "company":null, "address1":"Ha Nam", "address2":null, "city":"Hà Nội", "province":"Hà Nội", "province_code":"04", "country":"Việt Nam", "country_code":"VN", "zip":null}, "billing_address":{"id":0, "first_name":"Phong", "last_name":"Van", "phone":"0987654234", "company":null, "address1":"Ha Nam", "address2":null, "city":"Hà Nội", "province":"Hà Nội", "province_code":"04", "country":"Việt Nam", "country_code":"VN", "zip":null}, "discount":null};
                    //]]>
                </script>
                <script>
                    (function() {
                ...
                <body class="body--custom-background-color ">
                                ...
                                <div class="wrap clearfix">
                                    <div class="row thankyou-infos">
                                        <div class="col-md-7 thankyou-message">
                                            ...
                                            <div class="thankyou-message-text">
                                                ...
                                                <p>
                                                    Một email xác nhận đã được gửi tới buivtuan103@gmail.com. Xin vui lòng kiểm tra email của bạn
                                            ...
                                            <div class="order-summary order-summary--custom-background-color ">
                                                <div class="order-summary-header summary-header--thin summary-header--border">
                                                    <h2>
                                                        ...
                                                        #${orderuser.orderId}
                                                    <label class="control-label unprint">(2)</label>
                                                </h2>
                                                                ...
                                                                <li class="product product-has-image clearfix">
                                                                    <div class="product-thumbnail pull-left">
                                                                        <div class="product-thumbnail__wrapper">
                                                                            <img src="/QuanLyBanNongSan/jsp/Fontend/images/${cart.product.images}" alt="${cart.product.productName}" class="product-thumbnail__image" />
                                                                        </div>
                                                                        <span class="product-thumbnail__quantity unprint" aria-hidden="true">${cart.quantity}</span>
                                                                    </div>
                                                                    ...
                                                                    <c:choose>
                                                                        <c:when test="${cart.product.discountId==1}">
                                                                            <strong class="product-price pull-right">
                                                                                ${cart.product.priceOutput}₫
                                                                            </strong>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <strong class="product-price pull-right">
                                    ...
                                    <div class="col-md-7 col-sm-12 customer-info">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="order-summary order-summary--white no-border">
                                                        ...
                                                        <div class="summary-section no-border no-padding-top">
                                                            <span>Giao hàng tận nơi - Miễn phí giao hàng</span>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="order-success unprint">
                                            <a href="getAllProduct.htm" class="btn btn-primary">
                                                Tiếp tục mua hàng
                                            </a>
                    ...
                    <script src="/QuanLyBanNongSan/jsp/Fontend/js/jquery-2.2.3.min.js" type="text/javascript"></script>
                    <script src="/QuanLyBanNongSan/jsp/Fontend/js/bootstrap.min.js" type="text/javascript"></script>
                    <script src="/QuanLyBanNongSan/jsp/Fontend/js/twine.min.js" type="text/javascript"></script>
                    <script src="/QuanLyBanNongSan/jsp/Fontend/js/checkout.js" type="text/javascript"></script>
                    ...
                    <script src="/QuanLyBanNongSan/jsp/Fontend/js/thankyou.js" type="text/javascript"></script>
