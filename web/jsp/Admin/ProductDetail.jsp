                                    ...
                                    <div class="x_panel">
                                        ...
                                        <f:form class="form-horizontal form-label-left" action="updateProduct.htm" commandName="updateProduct" onsubmit="return validate()">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:textarea type="text" id="discription"  class="form-control col-md-7 col-xs-12" path="discription" readonly="true"/> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:textarea id="productContentDetail"  class="form-control col-md-7 col-xs-12" path="productContentDetail" readonly="true"></f:textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:input id="images"  type="text" class="form-control col-md-7 col-xs-12" path="images" readonly="true" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:input id="imagesHover" type="text" class="form-control col-md-7 col-xs-12" path="imageHover" readonly="true"/>
                                                </div>
                                            </div>
                                                    <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:input type="text" id="priceInput" class="form-control col-md-7 col-xs-12" path="priceInput" readonly="true" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:input type="text" id="priceOutput" class="form-control col-md-7 col-xs-12" path="priceOutput" readonly="true" />
                                                </div>
                                            </div>
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:input type="text" id="discountId" class="form-control col-md-7 col-xs-12" path="discountId" readonly="true"/>
                                                </div>
                                            </div>
...
<!--                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:select id="providerId" class="form-control col-md-7 col-xs-12" path="providerId" readonly="true">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:select id="id" class="form-control col-md-7 col-xs-12" path="id" >

                                                        <c:forEach items="${listCatalog}" var="catalog">
                                                            <f:option value="${catalog.id}" >${catalog.catalogName}</f:option>
                                                        </c:forEach>
                                                    </f:select>
                                                </div>
                                            </div>
