                        ...
                        <div class="breadcrumbs" id="breadcrumbs">
                            ...
                            <ul class="breadcrumb">
                                <li>
                                    ...
                                    <a href="homBackend.htm">Trang chủ</a>
                                </li>
                                <li class="active">Quản lí Banner</li>
                            </ul><!-- /.breadcrumb -->
                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h4>Quản lí Banner <small>  >> Sửa thông tin banner</small></h4>
                                            <div class="clearfix"></div>
                                        <f:form class="form-horizontal form-label-left" action="updateBanner.htm" commandName="updateBanner" onsubmit="return validate()">
                                            <div class="form-group message">
                                                 ${message}
                                             </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Mã Banner<span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <f:input type="text" id="bannerId" class="form-control col-md-7 col-xs-12" path="bannerId" readonly="true"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Độ ưu tiên hiển thị<span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
